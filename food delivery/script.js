...
const restaurants = [
    { id: 1, name: 'Restaurant A', rating: 4.5, reviews: 120, cuisine: 'Italian', menu: [{ name: 'Pizza', price: 100,image:'food delivery/pizza.jpg'}, { name: 'Burger', price: 150,image:'burger.jpg'},{name:'Showerma',price:140,image:'showerma.jpg'}] },
    { id: 2, name: 'Restaurant B', rating: 4.0, reviews: 80, cuisine: 'Chinese', menu: [{ name: 'Noodles', price: 80 ,image:'noodles.jpg'}, { name: 'Spring Rolls', price: 60 ,image:'springrolls.jpg'},{name:'grill chicken', price:160,image:'grillchicken.jpg'}] }
];
